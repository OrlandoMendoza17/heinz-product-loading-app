...
const Employees = async (request: NextApiRequest, response: NextApiResponse) => {
  ...
  const queryString = `
    SELECT AIARC, AICO, AIARC, AIAN8, ABALPH, ABTAX, AIAC03, AIAC05, ALADD1, ALADD2, ALCTY1, ALCOUN  FROM openquery(hveow001,'select * from proddta.f03012') 
    ...
    WHERE AICO = '07200' AND AIARC = 'EMP' AND AIHOLD= ''
  `
